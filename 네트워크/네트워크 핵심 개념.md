...
- TOS(Type Of Service)는 요구되는 서비스 품질을 나타낸다.
    ...
    -  Bit 0-2 :  Precedence (우선순위 8단계)
       ...
       . 100 : Flash [Override
       . 101 : Critical
       . 110 : [Internetwork](http://ktword.co.kr/test/view/view.php?m_temp1=461&id=894 "상호 접속 (Interconnection,Interconnect)  ㅇ 궁극적으로, 정보 및 신호의 원할한 이동을 구현하는 것    - 단순히 회로 내의 소자간 접속에서부터 ~ 이종 통신망 간 접속에 이르는    광범위한") [Control](http://ktword.co.kr/test/view/view.php?m_temp1=5240&id=245 "제어 (Control) 이란?  ㅇ 정상적이고 효율적으로 가동시키려는 행위(동작)   - 적당한 성능을 얻기위해, 시스템을 변화,조정하는 것          - 목적/목표에 이르도록, 대상물에 조작을") ([OSPF](http://ktword.co.kr/test/view/view.php?m_temp1=437&id=440 "OSPF  ㅇ 링크상태 라우팅 프로토콜에 기초하여,    - 자치시스템(AS) 내부의 라우터들끼리(IGP) 라우팅 정보를 교환하는 라우팅 프로토콜  ㅇ 출현배경   - 1980년대 중반에 RIP 라우팅")에서 셋팅됨)
       . 111 : [Network Control](http://ktword.co.kr/test/view/view.php?m_temp1=1934&id=299 "망 제어 (Network Control)   ㅇ 일반적으로 망의 서비스 등급/수준을 실시간 동적으로 유지관리하는 기능   - 망의 상태 감시를 통해 장애발생 및 성능저하를 신속히 탐지하고 적절한 제어를")

  ㅇ TOS 설정용 
     -  [Bit](http://ktword.co.kr/test/view/view.php?m_temp1=3823&id=122 "컴퓨터(디지털시스템)에서 수 표현 단위  ㅇ Digit (숫자)   - 아라비아 숫자(0~9)     . 기수법에서 매 자리 마다 쓰여질 수 있는 숫자    * 한편, 숫자 및 문자 등을 모두 포함하는 경우에는") 3 :  [Delay](http://ktword.co.kr/test/view/view.php?m_temp1=704&id=1068 "지연 (Delay,Latency) 이란?  ㅇ [채널 지연]   - 신호가 분산 매질의 채널을 지날때 주파수에 따라 다르게 겪는 시간 지연     . 이에따라 왜곡을 겪을 수 있음     ☞ 지연왜곡(위상왜곡),") ([지연](http://ktword.co.kr/test/view/view.php?m_temp1=704&id=1068 "지연 (Delay,Latency) 이란?  ㅇ [채널 지연]   - 신호가 분산 매질의 채널을 지날때 주파수에 따라 다르게 겪는 시간 지연     . 이에따라 왜곡을 겪을 수 있음     ☞ 지연왜곡(위상왜곡),")) 
       . 0 : 보통의 [지연](http://ktword.co.kr/test/view/view.php?m_temp1=704&id=1068 "지연 (Delay,Latency) 이란?  ㅇ [채널 지연]   - 신호가 분산 매질의 채널을 지날때 주파수에 따라 다르게 겪는 시간 지연     . 이에따라 왜곡을 겪을 수 있음     ☞ 지연왜곡(위상왜곡),"), 1 : 높은 [지연](http://ktword.co.kr/test/view/view.php?m_temp1=704&id=1068 "지연 (Delay,Latency) 이란?  ㅇ [채널 지연]   - 신호가 분산 매질의 채널을 지날때 주파수에 따라 다르게 겪는 시간 지연     . 이에따라 왜곡을 겪을 수 있음     ☞ 지연왜곡(위상왜곡),")
     -  [Bit](http://ktword.co.kr/test/view/view.php?m_temp1=3823&id=122 "컴퓨터(디지털시스템)에서 수 표현 단위  ㅇ Digit (숫자)   - 아라비아 숫자(0~9)     . 기수법에서 매 자리 마다 쓰여질 수 있는 숫자    * 한편, 숫자 및 문자 등을 모두 포함하는 경우에는") 4 :  [Throughput](http://ktword.co.kr/test/view/view.php?m_temp1=1918&id=1068 "Throughput (처리량,처리율)    ㅇ [통신]  단위 시간 당 운반 가능량 또는 무 오류 운반량   - (총량적 통신 관점) 통신 채널이 운반할 수 있는 데이터의 총량/전달 능력     . 단위 : byte/sec") ([처리율](http://ktword.co.kr/test/view/view.php?m_temp1=1918&id=1068 "Throughput (처리량,처리율)    ㅇ [통신]  단위 시간 당 운반 가능량 또는 무 오류 운반량   - (총량적 통신 관점) 통신 채널이 운반할 수 있는 데이터의 총량/전달 능력     . 단위 : byte/sec"))
       . 0 : 보통 [처리율](http://ktword.co.kr/test/view/view.php?m_temp1=1918&id=1068 "Throughput (처리량,처리율)    ㅇ [통신]  단위 시간 당 운반 가능량 또는 무 오류 운반량   - (총량적 통신 관점) 통신 채널이 운반할 수 있는 데이터의 총량/전달 능력     . 단위 : byte/sec"), 1 : 높은 [처리율](http://ktword.co.kr/test/view/view.php?m_temp1=1918&id=1068 "Throughput (처리량,처리율)    ㅇ [통신]  단위 시간 당 운반 가능량 또는 무 오류 운반량   - (총량적 통신 관점) 통신 채널이 운반할 수 있는 데이터의 총량/전달 능력     . 단위 : byte/sec")
     -  [Bit](http://ktword.co.kr/test/view/view.php?m_temp1=3823&id=122 "컴퓨터(디지털시스템)에서 수 표현 단위  ㅇ Digit (숫자)   - 아라비아 숫자(0~9)     . 기수법에서 매 자리 마다 쓰여질 수 있는 숫자    * 한편, 숫자 및 문자 등을 모두 포함하는 경우에는") 5 :  Reliability ([신뢰성](http://ktword.co.kr/test/view/view.php?m_temp1=1950&id=555 "[통신 분야] 신뢰성  ㅇ [ 일반 통신분야 ]   - `신뢰성 있는` = `오류가 없는` 통신 (Reliable Communication)     . 전송되는 신호가 오류,왜곡 등에 덜 취약하도록 하는 기술    * 신뢰적인"))
       . 0 : 보통 [신뢰성](http://ktword.co.kr/test/view/view.php?m_temp1=1950&id=555 "[통신 분야] 신뢰성  ㅇ [ 일반 통신분야 ]   - `신뢰성 있는` = `오류가 없는` 통신 (Reliable Communication)     . 전송되는 신호가 오류,왜곡 등에 덜 취약하도록 하는 기술    * 신뢰적인"), 1 : 높은 [신뢰성](http://ktword.co.kr/test/view/view.php?m_temp1=1950&id=555 "[통신 분야] 신뢰성  ㅇ [ 일반 통신분야 ]   - `신뢰성 있는` = `오류가 없는` 통신 (Reliable Communication)     . 전송되는 신호가 오류,왜곡 등에 덜 취약하도록 하는 기술    * 신뢰적인")
     -  [Bit](http://ktword.co.kr/test/view/view.php?m_temp1=3823&id=122 "컴퓨터(디지털시스템)에서 수 표현 단위  ㅇ Digit (숫자)   - 아라비아 숫자(0~9)     . 기수법에서 매 자리 마다 쓰여질 수 있는 숫자    * 한편, 숫자 및 문자 등을 모두 포함하는 경우에는") 6 :  Minimum Cost (최소비용)