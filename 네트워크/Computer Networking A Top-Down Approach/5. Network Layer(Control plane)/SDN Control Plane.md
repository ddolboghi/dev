...
# SDN의 과거와 미래
SDN의 개념은 최근에 부상했지만, 그 뿌리는 2004년경 데이터 플레인과 컨트롤 플레인의 분리를 주장한 연구들 [Feamster 2004, Lakshman 2004, RFC 3746] 및 ATM 제어 프레임워크 [van der Merwe 1998]로 거슬러 올라간다. 결정적으로 Ethane 프로젝트 [Casado 2007]가 플로우 기반 스위치와 중앙 집중형 컨트롤러 개념을 개척했으며, 이는 OpenFlow로 발전했다. 미래 연구 방향으로는 미들박스를 가상화하는 **NFV(네트워크 기능 가상화)** 와 SDN 제어를 **AS 간(inter-AS) 라우팅**으로 확장하는 것이 있다.