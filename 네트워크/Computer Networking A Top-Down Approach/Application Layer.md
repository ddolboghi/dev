...
일부 키워드는 필수이며 다른 키워드는 선택 사항입니다. 모든 헤더에는 **From:** **헤더 줄**과 **To:** **헤더 줄**이 반드시 포함되어야 합니다. 헤더에는 **Subject:** **헤더 줄**과 기타 선택적 헤더 줄도 포함될 수 있습니다.

<헤더와 SMTP 명령어의 차이점>

이러한 헤더 줄은 chapter 2.3.1에서 다룬 **SMTP 명령어**와는 다릅니다. SMTP 명령어는 SMTP 핸드셰이킹 프로토콜의 일부인 반면, 이 섹션에서 다루는 헤더 줄은 메일 메시지 자체의 일부입니다.
# DNS
