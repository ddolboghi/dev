...
- 앱 이름 작성: app-name을 입력하지 않고 앱을 생성했을때 작성합니다.
- 타입스크립트 사용: yes
...
# [styled-component 사용하기](https://nextjs.org/docs/app/building-your-application/styling/css-in-js#styled-components)
**styled-component v6 이상**
1. styled-component 설치하기
```
npm install styled-components
```

2. next.config.js에 다음 추가
```js
module.exports = {
  compiler: {
